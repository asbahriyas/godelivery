            ...
            child: Column(
              ...
              children: [
                Visibility(
                  visible: pickupIcon,
                  child: Image.asset(
                    "assets/Icons/ic_location_pickup.png",
                    scale: 4.5,
                  ),
                ),
              ],
...
//dropOff
            ...
            child: Column(
              ...
              children: [
                Visibility(
                  visible: dropoffIcon,
                  child: Image.asset(
                    "assets/Icons/ic_location_dropoff.png",
                    scale: 4.5,
                  ),
                ),
              ],
                  ...
                  child: MaterialButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.of(context)
                            .push(_DeliveryDetailsScreenRoute());
                      },
                      child: Text(
                        "Started",
                        style: TextStyle(
    ...
    return SafeArea(
      ...
      body: Stack(
        ...
        children: <Widget>[
          ...
          //Map
          googleMap(context),
          Visibility(visible: pickup, child: pickupScreen()),
          Visibility(visible: dropoff, child: dropOff()),
          Visibility(visible: getStart, child: getStarted()),
          //
        ],
      ),
    ));
  ...
  List<MyConstClass> myList = [
    MyConstClass(
        img: "assets/Icons/ic_delivery_car.png",
        title: "Car Delivery",
        subtitle: "Pickup and Delivery Package in a Car"),
    MyConstClass(
        img: "assets/Icons/ic_delivery_bike.png",
        title: "Delivery",
        subtitle: "Pickup and Delivery through bike"),
    MyConstClass(
        img: "assets/Icons/ic_delivery_cargo.png",
        title: "Pickup",
        subtitle: "Order pickup and deliver big luggage"),
  ];
  void deliveryPopup() async {
    final result = await showModalBottomSheet(
        ...
        builder: (BuildContext context) {
          return Container(
            constraints: BoxConstraints(minHeight: 50, maxHeight: 235),
            decoration: BoxDecoration(
                color: Colors.white,
